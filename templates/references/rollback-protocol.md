...
4. If confirmed:
   ...
   - Run `dominion-cli rollback --to-wave {N}` to update progress.toml and state.toml
...
4. If confirmed:
   ...
   - Run `dominion-cli rollback --task {id}` to update progress.toml and state.toml
...
4. If confirmed:
   ...
   - Run `dominion-cli rollback --to-phase {N}` to update state.toml and clean up phase artifacts
